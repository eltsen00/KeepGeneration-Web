...
class KeepSultan:
    ...
    def process(self):
        ...
        self.image_editor.add_text(f'{self.configs["date"]} {start_time[:-3]} - {end_time} {self.configs["location"]} · {self.configs["weather"]} · {self.configs["temperature"]}', (160, 290), "fonts/SourceHanSansCN-Regular.otf", 36, (155, 155, 155)) #日期
